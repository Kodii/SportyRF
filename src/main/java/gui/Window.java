...
public class Window extends JFrame {
    ...
    private void initUI() {
        ...
        JMenuItem menuCompetitionNew = new JMenuItem("NOWE", menuCompetitionNewIcon);
        ...
        // Menu Competitor - new
        JMenuItem menuCompetititorNew = new JMenuItem("NOWY", menuCompetitorNewIcon);
        ...
        // Menu RFID - connect
        JMenuItem menuRFIDConnect = new JMenuItem("POĹ�Ä„CZ", menuRFIDConnectIcon);
        ...
        JMenuItem menuRFIDSetToCompetitor= new JMenuItem("PRZYPISZ DO ZAWODNIKA");
    ...
    public void createPage1() {
        ...
        //jpanelStartList.setLayout(new BoxLayout(jpanelStartList, BoxLayout.PAGE_AXIS));
...
//      TOOLBAR
        ...
        jpanelInside.setLayout(new BoxLayout(jpanelInside, BoxLayout.LINE_AXIS));
...
//      TOOLBAR
    ...
    private void exitOnClose() {    // Functionality of button X on window pane
        ...
        if (JOptionPane.showConfirmDialog(
                this,
                "JesteĹ› pewny, ĹĽe chcesz wyjĹ›Ä‡?",
                "ZatwierdĹş",
